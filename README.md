...
### 2. Pokrenuti željeni program:  
(nije nužno pokrenuti 2.1. i 2.2. prije 2.3., može se testirati bilo kojim redoslijedom)
...
- --epsilon EPSILON: pokreće napad za jednu epsilon vrijednost i vizualizira nekoliko suparničkih primjera za tu vrijednost
